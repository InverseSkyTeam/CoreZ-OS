...
static void inorder_recursive(struct RB_NODE *node,
                              void (*func)(struct RB_NODE *, void *),
                              void *arg) {
    if (!node)
        return;
    inorder_recursive(node->left, func, arg);
    func(node, arg);
    inorder_recursive(node->right, func, arg);
}

void rb_inorder(struct RB_ROOT *root, void (*func)(struct RB_NODE *, void *),
                void *arg) {
    inorder_recursive(root->root, func, arg);
}